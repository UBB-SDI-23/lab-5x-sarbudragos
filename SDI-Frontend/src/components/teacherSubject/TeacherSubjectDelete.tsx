...
export const TeacherSubjectDelete = () => {
	...
	const handleDelete = async (event: { preventDefault: () => void }) => {
		...
		await axios.delete(`${BACKEND_ADDR}/teacher-subjects/${teacherSubjectId}`);
	...
	return (
		<Container>
            {operationState === "success" && 
                <Alert severity="success">teacherSubject deleted successfully!</Alert>
            }
			...
			<Card>
				<CardContent>
					...
					Are you sure you want to delete this teacher-subject? This cannot be undone!
				</CardContent>
				<CardActions>
